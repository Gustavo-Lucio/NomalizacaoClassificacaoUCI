...
dados = pd.read_csv('D:/DS/wdbc.txt', sep = ',')
...
dump(modelo_normalizador,open('D:/DS/wdbc_normalizado.pkl', 'wb'))

modelo_normalizador  = load(open('D:/DS/wdbc_normalizado.pkl', 'rb'))
